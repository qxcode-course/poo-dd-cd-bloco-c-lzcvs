...
- Criar um array preenchido
  - preenchendo já com valores durante a criação OK
- Obter o tamanho do array OK
- Adicionar e remover elementos ao final OK
- Adicionar e remover elementos no início OK
